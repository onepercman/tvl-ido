...
export const button = tv({
  ...
  variants: {
    size: {
      ...
      sm: "px-3 text-xs [--button-size:2rem]",
      md: "px-4 text-sm [--button-size:2.75rem]",
      lg: "px-8 text-base [--button-size:54px]",
    },
    variant: {
      default: "border-0",
      outlined: "border-2",
  ...
  compoundVariants: [
    // default
    {
      variant: "default",
      color: "default",
      class: ["border border-line-3 bg-default backdrop-blur"],
    },
    {
      variant: "default",
      color: "primary",
