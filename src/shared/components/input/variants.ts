...
export const input = tv({
  base: [
    "inline-flex cursor-text items-center gap-2 overflow-hidden text-ellipsis rounded border border-transparent px-2 transition-all focus-within:border-primary",
  ...
  variants: {
    size: {
      ...
      md: "px-4 text-sm [--input-size:2.75rem]",
      lg: "px-4 [--input-size:2.75rem]",
    },
    variant: {
      filled: "border border-foreground/10 bg-default",
